...
// TF Lite Interpreter used to run our model
#include "tensorflow/lite/micro/testing/micro_test.h"
// A lightweight framework for writing tests, which allows us to run this file as a test
#include "tensorflow/lite/schema/schema_generated.h"
// The schema that defines the structure of TF Lite FlatBuffer data,
//  used to make sense of the model data in sine_model_data.h
#include "tensorflow/lite/version.h"
// The current version number of the schema, 
// so we can check that the model was defined with a compatible version

// The following code is used by the TensorFlow Lite
//  for Microcontrollers testing framework
TF_LITE_MICRO_TESTS_BEGIN
// macros - reusable code chunks defined in micro_test.h
// wraps the rest of code for TF Lite testing framework to work
